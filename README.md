...
### Extra 
[Я сделал пр](https://github.com/Daniel-Shegida/list_of_users_test_task/pull/1), в котором есть вся задача, в котором можно делать пометки или подсказать, как можно было сделать лучше
